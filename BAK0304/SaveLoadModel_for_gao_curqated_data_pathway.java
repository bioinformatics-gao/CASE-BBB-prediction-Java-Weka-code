...
public class SaveLoadModel_for_gao_curqated_data_pathway {
	...
	public static void main(String args[]) throws Exception{
		...
		for(int num=0; num< 1000; num++){
			...
			// Load data  
			//DataSource source = new DataSource("C:/Users/User/Dropbox/Maching-Learning-Weka/2016-02-28-data/Zhen-curated-data/Pathway-sideeffects/01-26-CNS_pathway-for-working1.csv");
			//DataSource source = new DataSource("C:/Users/User/Dropbox/Maching-Learning-Weka/2016-02-28-data/Zhen-curated-data/Pathway-sideeffects/01-26-CNS_pathway-working2.csv");
			DataSource source = new DataSource("C:/Users/User/Dropbox/Maching-Learning-Weka/2016-02-28-data/Zhen-curated-data/Pathway-sideeffects/01-26-pathway-only-working2.csv");
