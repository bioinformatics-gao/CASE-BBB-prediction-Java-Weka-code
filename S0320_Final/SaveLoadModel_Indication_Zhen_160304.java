...
public class SaveLoadModel_Indication_Zhen_160304 {
	...
	public static void main(String args[]) throws Exception{
		...
		for(int num=0; num< 1000; num++){
			...
			// Load data  
			DataSource source = new DataSource("C:/Users/User/Dropbox/Maching-Learning-Weka/03-20-4-set-training-2set-validation/2003-2006-2005-2004-logB-drug_CID-without-2015Hao-Indications.csv");
			...
			weka.core.SerializationHelper.write("Indication_model"+ num +".model", smo);
			
			eval1[num] = new Evaluation(trainDataset);
			eval1[num].evaluateModel(smo,trainDataset);
			
			SMO smo2 = (SMO) weka.core.SerializationHelper.read("Indication_model"+ num +".model");
